...
메뉴 순서는 **카메라 설정 / 제품 레시피 / 생산 검사 / PLC 통신 진단 / PLC 디버그**입니다. 카메라 설정은 별도 설정 창을 엽니다.
...
**카메라 설정:** 검사 관리 메뉴에서 제품 레시피 앞의 **카메라 설정** 버튼으로 Inspect가 검색한 Basler 카메라의 시리얼·IP·모델을 확인합니다.
